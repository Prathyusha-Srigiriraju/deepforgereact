...
import media_bg from '../assets/img/main/media_bg.png';
import media2 from '../assets/img/main/media2.png';
...
var mediaandentertainment_bnr = {
    backgroundImage: `url(${media_bg})`
  };
class mediaandentertainment extends Component {
  ...
  render() {
    ...
    return (
        <div>
            <div className="innerPage" style={mediaandentertainment_bnr}>
            <div className="container section_container pr-0">
             <div className="row">
                 <div className="col-lg-8 col-md-12 col-xs-12">
                  <div className="innerPagehead">
                    <h1>Home > Use cases > Media and Entertainment</h1>
...
<img src={financial_img} alt="Deepforge-Ai" width="100"/>
		...
		<p>Conversational assistants bring two-way, relational interactions to digital banking channels. Financial services companies can reduce service costs and improve customer satisfaction by deploying bots for simple banking transactions and tier-1 support resolution.
</p></div>
...
<img src={ecommerce_img} alt="Deepforge-Ai" width="100"/>
		...
		<p>Retail and Ecommerce companies can use conversational selling to increase wallet share and customer satisfaction. Intelligent voice and chat assistants delivering personalized shopping experiences and 24/7 support can drive digital sales for e-tailers.
</p></div>
...
<img src={healthcare_img} alt="Deepforge-Ai" width="100"/>
		...
		<p> AI assistants enable personalized care while lowering the overall cost of care. Healthcare organizations delivering conversational care via chatbots and voice assistants are seeing improvements in patient experience, care management and medical staff productivity.
</p></div>
