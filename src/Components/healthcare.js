...
import healthcare1 from '../assets/img/main/healthcare1.png';
import healthcare_bg from '../assets/img/main/healthcare_bg.png';
...
var healthcare_bnr = {
    backgroundImage: `url(${healthcare_bg})`
  };
    ...
    return (
        <div>
            ...
            <div className="innerpage_sec pb-0">
               ...
               <h6 className="text-center">AI assistants enable personalized care while lowering the overall cost of care. Healthcare organizations delivering conversational care via chatbots and voice assistants are seeing improvements in patient experience, care management and medical staff productivity.</h6>
               <div className="row innerpage_row align-items-center">
               <div className="col-lg-5 col-md-6 col-xs-12">
                   <img src={healthcare1} alt="healthcare"/>
                   </div>
                   <div className="col-lg-7 col-md-6 col-xs-12 d-flex">
                   <ul>
                       {/* <img src={list_style} className="list_style img-fluid"/> */}
                           <li><h5>Appointment Booking 
 </h5>
                           </li>
                           <li><h5>Patient Care </h5>
                           </li>
                           <li><h5>Doctor Assist </h5>
                           </li>
                           
                           <li className="mb-0"><h5>Nurse Assist</h5>
                           </li>
                       </ul>
                       <ul className="ml-5">
                       {/* <img src={list_style} className="list_style img-fluid"/> */}
                       <li><h5>Patient Health Records Integration  </h5>
                           </li>
                           <li><h5>Billing Services
 </h5>
                           </li>
                           <li><h5>Material Management  </h5>
                           </li>
                           <li className="mb-0"><h5>Insurance-Related Services </h5>
                           </li>
