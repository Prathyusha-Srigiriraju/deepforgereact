...
import ecommerce_bg from '../assets/img/main/ecommerce_bg.png';

import ecommerce from '../assets/img/main/ecommerce.png';
...
var ecommerce_bnr = {
    backgroundImage: `url(${ecommerce_bg})`
  };
class retailandecommerce extends Component {
    state= {
        responsive:{
            0: {
                items: 1,
  ...
  render() {
    ...
    return (
        <div>
            <div className="innerPage" style={ecommerce_bnr}>
            <div className="container section_container pr-0">
             <div className="row">
                 <div className="col-lg-8 col-md-12 col-xs-12">
                  <div className="innerPagehead">
                    <h1>Home > Use cases > Retail and Ecommerce</h1>
            ...
            <div className="innerpage_sec pb-0">
               ...
               <h6 className="text-center">Retail and Ecommerce companies can use conversational selling to increase wallet share and customer satisfaction. Intelligent voice and chat assistants delivering personalized shopping experiences and 24/7 support can drive digital sales for e-tailers.
</h6>
               <div className="row innerpage_row align-items-center">
               <div className="col-lg-5 col-md-6 col-xs-12">
                   <img src={ecommerce} alt="retail-ecommerce"/>
                   </div>
                   <div className="col-lg-7 col-md-6 col-xs-12 d-flex">
                   <ul>
                       {/* <img src={list_style} className="list_style img-fluid"/> */}
                           <li><h5>Hyper personalization  </h5>
                           </li>
                           <li><h5>Cross-sell and Up-sell  </h5>
                           </li>
                           <li><h5>Customer Engagement </h5>
                           </li>
                           <li className="mb-0"><h5>Personalised Experience</h5>
                           </li>
                           
                       </ul>
                       <ul className="ml-5">
                       {/* <img src={list_style} className="list_style img-fluid"/> */}
                       <li ><h5>Product Feedback Management </h5>
                           </li>
                           <li><h5>Product Comparisons </h5>
                           </li>
                           <li><h5>Order Tracking </h5>
                           </li>
                           <li className="mb-0"><h5>Store locator </h5>
                           </li>
                       </ul>
                   </div>
