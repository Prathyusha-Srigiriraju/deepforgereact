...
import financial from '../assets/img/main/financial.png';
import financial_bg from '../assets/img/main/financial_bg.png';
...
var financial_bnr = {
    backgroundImage: `url(${financial_bg})`
  };
class healthcare extends Component {
  ...
  render() {
    ...
    return (
        <div>
            <div className="innerPage" style={financial_bnr}>
            <div className="container section_container pr-0">
             <div className="row">
                 <div className="col-lg-8 col-md-12 col-xs-12">
                  <div className="innerPagehead">
                    <h1>Home > Use cases > Banking and Financial Services </h1>
            ...
            <div className="innerpage_sec pb-0">
               ...
               <h6 className="text-center">Conversational assistants bring two-way, relational interactions to digital banking channels. Financial services companies can reduce service costs and improve customer satisfaction by deploying bots for simple banking transactions and tier-1 support resolution.
</h6>
               <div className="row innerpage_row align-items-center">
               <div className="col-lg-5 col-md-6 col-xs-12">
                   <img src={financial} alt="banking"/>
                   </div>
                   <div className="col-lg-7 col-md-6 col-xs-12 d-flex">
                   <ul>
                       {/* <img src={list_style} className="list_style img-fluid"/> */}
                           <li><h5>Contextual Banking </h5>
                           </li>
                           <li><h5>24*7 Customer Support </h5>
                           </li>
                           <li><h5>Financial Advice </h5>
                           </li>
                           <li className="mb-0"><h5>Digital Selling  </h5>
                           </li>
                           
                       </ul>
                       <ul className="ml-5">
                       {/* <img src={list_style} className="list_style img-fluid"/> */}
                       <li ><h5>Self Service enablement </h5>
                           </li>
                           <li><h5>Promotional Offers
 </h5>
                           </li>
                           <li><h5>Tracking Application Status </h5>
                           </li>
                           <li className="mb-0"><h5>Personal Fund Advisor </h5>
                           </li>
