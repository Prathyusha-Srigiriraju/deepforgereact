...
import education_bg from '../assets/img/main/education_bg.png';
import education from '../assets/img/main/education.png';
...
var education_bnr = {
    backgroundImage: `url(${education_bg})`
  };
class education_usecase extends Component {
    state= {
        responsive:{
            0: {
                items: 1,
    ...
    return (
        <div>
            ...
            <div className="innerpage_sec pb-0">
               ...
               <h6 className="text-center">Conversational AI is quickly changing education and eLearning by bringing constructive change to the learning process and make it more efficient.
               ...
               <div className="col-lg-5 col-md-6 col-xs-12">
                   ...
                   <ul>
                       {/* <img src={list_style} className="list_style img-fluid"/> */}
                           <li><h5>Teaching assistants
</h5>
                           </li>
                           <li><h5>Student Guides </h5>
                           </li>
                           <li><h5>Smart Feedbacks </h5>
                           </li>
                          
                           <li className="mb-0"><h5>Information Updation </h5>
                           </li>
                       </ul>
                       <ul className="ml-5">
                       {/* <img src={list_style} className="list_style img-fluid"/> */}
                           <li><h5>Student Onboarding 
</h5>
                           </li>
                           <li><h5>Scholarship related Services </h5>
                           </li>
                           <li><h5>Instant Support </h5>
                           </li>
                           <li className="mb-0"><h5>Administrative tasks Automation  </h5>
                           </li>
                       </ul>
                   </div>
...
<div className="items">
<img src={financial_img} alt="banking" width="100"/>
...
<div className="items">
<img src={realestate_img} alt="real-estate" width="100%"/>
		<div className="card_body">
        <div className="card_body1">
		<h5>Real Estate
</h5>
...
<div class="callcatin_btn_div">
  ...
  export default education_usecase;