...
import our_platform_is_omnichannel_bg from '../assets/img/main/our_platform_is_omnichannel_bg.png';
import our_platform_is_omnichannel_img from '../assets/img/main/our_platform_is_omnichannel_img.png';
...
var our_platform_is_omnichannel_bnr = {
    backgroundImage: `url(${our_platform_is_omnichannel_bg})`
  };
class our_platform_is_omnichannel extends Component {
    state= {
  ...
  render() {
    ...
    return (
        <div>
            <div className="innerPage" style={our_platform_is_omnichannel_bnr}>
            <div className="container section_container pr-0">
             <div className="row">
                 <div className="col-lg-8 col-md-12 col-xs-12">
                  <div className="innerPagehead">
                    <h1>Home > Capabilities > We Build Omnichannel Experiences</h1>
                    <div className="border1"></div>
                    <h2>We Build Omnichannel Experiences</h2>
                  </div>
                 </div>
...
We can deploy our digital agents on any channel, any device, any platform where your customers are there. One-click channel integrations make digital agents easy to use and maintain.
               ...
               <img src={our_platform_is_omnichannel_img} alt="our-platform-is-omnichannel"/>
                   </div>
                   <div className="col-lg-7 col-md-6 col-xs-12">
                       <ul className="cap_list">
                       {/* <img src={list_style} className="list_style img-fluid"/> */}
                       <p>We build great omnichannel contextual experiences, be it on enterprise messengers like Slack, Skype, etc. or voice assistants or social messaging apps or IVRs or mobile apps, etc. or any kind of channel.


</p>
                         <p className="mt-3">Create once-Deploy Everywhere : We believe in creating conversational experiences with consistency in every channel's message to deliver the right tone and flavour to the end-users.
</p>
...
<div className="d-flex align-items-center"><Link to="/capabilities/we-develop-and-deliver-agnostic-experiences"><button className="primary_btn d-flex align-items-center platform_btn">Know More</button></Link></div>
		...
		<p>We can deploy our digital agents on any channel, any device, any platform where your customers are there.  One-click channel integrations makedigital agents easy to use and maintain.</p>
...
<div class="callcatin_btn_div">
  ...
  export default our_platform_is_omnichannel;