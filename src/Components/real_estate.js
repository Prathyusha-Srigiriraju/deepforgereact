...
import realestate_bg from '../assets/img/main/realestate_bg.png';

import realestate from '../assets/img/main/realestate.png';
...
var realestate_bnr = {
    backgroundImage: `url(${realestate_bg})`
  };
class real_estate extends Component {
    state= {
        responsive:{
            0: {
                items: 1,
    ...
    return (
        <div>
            ...
            <div className="innerpage_sec pb-0">
               ...
               <h6 className="text-center">Real estate industry is making headway into using Conversational AI and transforming customer support and experience segments. AI assistants and chat agents can engage, nurture, and convert buyers and sellers into clients. Sales and Marketing teams are seemingly successful as qualified lead volumes increase and spam hassle goes down.</h6>
               ...
               <div className="col-lg-5 col-md-6 col-xs-12">
                   ...
                   <ul>
                       {/* <img src={list_style} className="list_style img-fluid"/> */}
                           <li><h5>Personal 24*7 assistance 
 </h5>
                           </li>
                           <li><h5>Lead Generation and Qualification </h5>
                           </li>
                           <li><h5>Project Information Assistance </h5>
                           </li>
                          
                           <li className="mb-0"><h5>Scheduling a site visit</h5>
                           </li>
                       </ul>
                       <ul className="ml-5">
                       {/* <img src={list_style} className="list_style img-fluid"/> */}
                           <li><h5>Loan Assistance  </h5>
                           </li>
                           <li><h5>Project Promotions </h5>
                           </li>
                           <li><h5>Owner-Buyer assistance </h5>
                           </li>
                           <li className="mb-0"><h5>Sales Enablement</h5>
                           </li>
                       </ul>
                   </div>
