...
import our_platform_is_domain_agnostic from './Components/our_platform_is_domain_agnostic';
import deep_vertical_domain_knowledge from './Components/deep_vertical_domain_knowledge';
import platform_with_robust_features from './Components/platform_with_robust_features';
import our_platform_is_omnichannel from './Components/our_platform_is_omnichannel';
...
import education_usecase from './Components/education_usecase';
import healthcare from './Components/healthcare';
import financial_services from './Components/financial_services';
import allusecases from './Components/allusecases';
import partner from './Components/partner';
import what_we_do from './Components/what_we_do.js';
import terms from './Components/terms';
import header_logo from './assets/img/main/header_logo.svg';
...
// import backTop from './assets/img/back.svg' 
...
$(window).scroll(function () {
  ...
  render() {
    ...
    return (  
      ...
      <Helmet>
      <title> Deepforge AI - Contact - Conversational AI for Enterprise | Intelligent Digital Agents </title>
      ...
      <li class="nav-item dropdown d-block d-sm-block d-md-none">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          ...
          <a class="dropdown-item" href="/contact-us">Contact Us</a>
            ...
            <Route  exact path="/capabilities/deep-vertical-domain-knowledge"  component={deep_vertical_domain_knowledge}  />
          ...
          <div className="col-lg-4 col-md-12 col-xs-12 pl-0">
             ...
             <div className="d-flex align-items-center">
               ...
               <div className="d-flex align-items-center">
                <div className="policy_link d-flex align-items-center">
